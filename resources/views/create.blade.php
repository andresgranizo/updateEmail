...
<div class="mb-3">
  <button class="btn btn-link p-0" type="button" data-bs-toggle="collapse" data-bs-target="#politicaPrivacidad" aria-expanded="false" aria-controls="politicaPrivacidad">
  ...
  <div class="collapse mt-3" id="politicaPrivacidad">
    <div class="card card-body" style="max-height: 300px; overflow-y: scroll; font-size: 0.95rem;">
      ...
      Esta política de protección y tratamiento de datos de carácter personal se aplica a todos los datos personales que se recolecten, almacenen, manejen y usen en el acceso a los portales y sistemas web que tiene habilitado la Secretaría de Educación Superior, Ciencia, Tecnología e Innovación.</p>

      <p>Esta política es de acceso público, motivo por el cual cualquier persona puede acceder a la información publicada en relación con el Tratamiento de Datos Personales y la protección de su información contenida en las Bases de Datos.</p>

      <p><strong>Datos que se recolectan:</strong><br>
      En los portales y sistemas web de la SENESCYT, según la funcionalidad accedida, se recolecta la siguiente información:</p>
      ...
      La SENESCYT podrá actualizar esta política y notificará los cambios sustanciales mediante aviso en el portal correspondiente.</p>

      <p><strong>Uso de cookies:</strong><br>
      Se utilizan cookies para mejorar la navegación, calidad del sitio y experiencia del usuario. No se comparte esta información.</p>

      <p><strong>Medidas de seguridad:</strong><br>
      Se mantienen protocolos estrictos para garantizar que los usuarios con acceso a datos personales no divulguen la información.</p>

      <p><strong>Base legal:</strong></p>
      <ul>
        <li>Ley de Comercio Electrónico, Firmas Electrónicas y Mensajes de Datos (Ley No. 2002-67).</li>
        <li>Plan de la Sociedad de la Información y del Conocimiento: Acuerdo Ministerial Nro. 016-2018.</li>
        <li>Código Orgánico de la Economía Social de los Conocimientos: Disposición VIGÉSIMA SÉPTIMA.</li>
        <li>Ley Orgánica de Protección de Datos Personales y su Reglamento.</li>
      </ul>

      <h5 class="mt-4">II. TÉRMINOS Y CONDICIONES DE USO</h5>

      <p>El uso del portal implica la aceptación de estos términos. La SENESCYT dispone de los portales web para brindar información conforme a sus competencias.</p>

      <p>El titular consiente libre, específica e informadamente el tratamiento de sus datos personales.</p>

      <p><strong>Responsabilidad:</strong><br>
      La SENESCYT es responsable únicamente del tratamiento de los datos recolectados directamente en sus portales. No se responsabiliza del uso inadecuado por parte del usuario.</p>

      <p><strong>Obligaciones del usuario:</strong></p>
      <ul>
        <li>No dañar, inutilizar, modificar o deteriorar los canales electrónicos o sus contenidos.</li>
